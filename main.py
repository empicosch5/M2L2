...
def send_welcome(message):
    bot.reply_to(
        message,
        f'Привет! Я бот {bot.get_me().first_name} и я помогу тебе заботиться о природе при помощи команд /ecology, /random_help, /trash und /tip!'
    )
...
@bot.message_handler(commands=['random_help'])
